...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"template/atcoder_template.hpp\"\n#ifdef LOCAL\n#define _GLIBCXX_DEBUG\n\
    #endif\n#include <bits/stdc++.h>\n#include <atcoder/all>\nusing namespace std;\n\
  ...
  verifiedWith: []
documentation_of: template/atcoder_template.hpp
layout: document
redirect_from:
- /library/template/atcoder_template.hpp
- /library/template/atcoder_template.hpp.html
