...
data:
  ...
  bundledCode: "#line 1 \"algo/verify/yosupo/vertex_add_subtree_sum.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/vertex_add_subtree_sum\"\n\n#include\
    \ <iostream>\n#include <vector>\n#include <functional>\nusing namespace std;\n\
    ...
    };\n#line 10 \"algo/verify/yosupo/vertex_add_subtree_sum.test.cpp\"\n\nlong long\
  ...
  verifiedWith: []
documentation_of: algo/verify/yosupo/vertex_add_subtree_sum.test.cpp
layout: document
redirect_from:
- /verify/algo/verify/yosupo/vertex_add_subtree_sum.test.cpp
- /verify/algo/verify/yosupo/vertex_add_subtree_sum.test.cpp.html
