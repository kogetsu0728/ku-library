...
data:
  ...
  bundledCode: "#line 1 \"algo/verify/yosupo/static_range_min.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/staticrmq\"\n\n#include <iostream>\n\
    ...
    \ v_r);\n\t\t}\n\n\t\tvoid set(int i, S x){\n\t\t\ti += n;\n\t\t\tv[i] = x;\n\t\
    \t\twhile(1<i){\n\t\t\t\ti >>= 1;\n\t\t\t\tupdate(i);\n\t\t\t}\n\t\t}\n};\n#line\
    \ 8 \"algo/verify/yosupo/static_range_min.test.cpp\"\n\nlong long op(long long\
    \ a, long long b){\n\treturn min(a, b);\n}\n\nlong long e(){\n\treturn 1LL<<60;\n\
    }\n\nint main(){\n\tint N, Q;\n\tcin >> N >> Q;\n\tvector<long long> A(N);\n\t\
    for(int i=0; i<N; i++){\n\t\tcin >> A[i];\n\t}\n\n\tSegmentTree<long long, op,\
    \ e> seg(A);\n\tfor(;Q--;){\n\t\tint l, r;\n\t\tcin >> l >> r;\n\t\tcout << seg.prod(l,r)\
    \ << endl;\n\t}\n}\n"
  ...
  verifiedWith: []
documentation_of: algo/verify/yosupo/static_range_min.test.cpp
layout: document
redirect_from:
- /verify/algo/verify/yosupo/static_range_min.test.cpp
- /verify/algo/verify/yosupo/static_range_min.test.cpp.html
