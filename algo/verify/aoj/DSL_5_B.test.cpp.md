...
data:
  ...
  bundledCode: "#line 1 \"algo/verify/aoj/DSL_5_B.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_5_B\"\
    \n\n#include <iostream>\n#include <vector>\n#include <algorithm>\nusing namespace\
    \ std;\n\n#line 2 \"algo/data_structure/cumulative_sum_2d.hpp\"\n\ntemplate<class\
    ...
    \t\t}\n};\n#line 9 \"algo/verify/aoj/DSL_5_B.test.cpp\"\n\nint main(){\n\tint\
  ...
  verifiedWith: []
documentation_of: algo/verify/aoj/DSL_5_B.test.cpp
layout: document
redirect_from:
- /verify/algo/verify/aoj/DSL_5_B.test.cpp
- /verify/algo/verify/aoj/DSL_5_B.test.cpp.html
